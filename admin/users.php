                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                            <a class="btn btn-primary me-3" href="add_users.php"> Add User </a>
            ...
            <div class="container-fluid">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        $query = mysqli_query($conn, "SELECT * FROM tb_multi_user;");
                        ...
                        <?php foreach ($fetches as $fetch) : ?>
                            <tr>
                                ...
                                <td><a class="badge bg-primary" href=""><i class="bi bi-eye"></i></a>
                                    <a class="badge bg-warning" href=""><i class="bi bi-pencil-square"></i></a>
                                    <a class="badge bg-danger" href="/admin/inc/hapus.php" onclick="return confirm('are you sure?')"><i class="bi bi-trash"></i></a></>
                                </td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>

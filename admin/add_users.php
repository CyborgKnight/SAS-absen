...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        // $hash = hash(PASSWORD_BCRYPT, $password);

        $level = stripslashes($_POST['level']);
        $level = mysqli_real_escape_string($conn, $level);

        $query = "INSERT into `tb_multi_user` (nama_lengkap, nis, jenis_kelamin, password, level)
		VALUES ('$nama', '$nis', '$jenis_kelamin', '$password', '$level')";
    ...
    ?>
        <div class="container">
            ...
            <form name="" action="" method="post">
                ...
                <tr>
                    <td>
                        <a class="btn btn-primary d-block mt-3" href="users.php"> Kembali </a>
                    </td>
                </tr>
            </form>
        </div>
